...
- circuitul complet de CO₂ — compresor, două gas coolere în serie, vană de
  expansiune electronică, evaporator
- circuitul de apă sursă (5/0 °C) și cel de încălzire (55/45 °C)
- producerea de ACM: 2 × 300 l în serie, încălzite direct de CO₂ prin HX-302
- instrumentație, vane de izolare, interblocări și alarme după logica din P&ID
- **listă de linii generată din model** — lungimi reale pe axa curbelor,
  număr de coturi și totaluri pe diametru

## Utilizare

- **Orbit / Liber (WASD)** — două moduri de cameră
- click pe orice componentă → fișa ei tehnică, cota de montaj și racordurile
- scenarii: regim nominal, pornire, standby, val de dușuri, două alarme
